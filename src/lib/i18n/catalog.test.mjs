...
test("Catalog (I18N-004): detail-surface keys resolve to non-empty strings in both locales", async () => {
    ...
    const requiredKeys = [
        ...
        // type-aware transcription (feature 057)
        "analysis.tsection_general",
        "analysis.tsection_issuer",
        "analysis.tsection_provider",
        "analysis.tsection_recipient",
        "analysis.tsection_payer",
        "analysis.tsection_values",
        "analysis.tsection_totals",
        "analysis.tsection_retentions",
        "analysis.tsection_bank",
        "analysis.tsection_items",
        "analysis.tsection_duplicates",
        "analysis.tsection_identified_values",
        "analysis.tsection_raw_text",
        "analysis.provenance_total",
        "analysis.provenance_issuer",
        "analysis.provenance_number",
        "analysis.provenance_date",
        "analysis.provenance_service",
        // page-image viewer
